...
import { IVideoCardProps, OperationTypes } from '@/types/newfileform.type'
import useDownloader from 'react-use-downloader'
import { ContentType } from '@/types/card.type'


const VideoEditCard = ({ data, title, tags, openEditor, setData, openViewer, setNewFileRequest, canEdit, id }: IVideoCardProps) => {
                ...
                <div className="data-card__manager">
                    {canEdit &&
                        <>
                            ...
                            <button className="data-card__btn" onClick={() => { SetData(); setNewFileRequest({ video: false, image: false, album: false, contentType: ContentType.VIDEO, reqType: OperationTypes.UPDATE }); openEditor(true) }}>
                    ...
                    <button onClick={() => download(data.default, `${title}.mp4`)} className="data-card__btn">
