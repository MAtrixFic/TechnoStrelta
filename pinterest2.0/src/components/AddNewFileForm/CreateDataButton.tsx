...
import { OperationTypes, newFileRequest } from '@/types/newfileform.type';
...
const CreateDataButton = ({ newData, setNewFileRequest }: ICreateDataButtonProps) => {

    return (
        <button onClick={() => { setNewFileRequest({ video: true, image: true, album: true, contentType: ContentType.PHOTO, reqType: OperationTypes.CREATE }); newData(true) }} className='user-space__create'>
