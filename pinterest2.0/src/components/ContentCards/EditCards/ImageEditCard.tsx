...
const ImageEditCard = ({ setData, openEditor, openViewer, data, title, tags, meta, location }: IPhotoCardProps) => {
        ...
        <article className='data-card'>
            ...
            <div className="data-card__data">
                <div className="data-card__manager">
                    ...
                    <button className="data-card__btn" onClick={() => { SetData(); openEditor(true) }}>
