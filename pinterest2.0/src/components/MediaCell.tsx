...
const MediaCell = ({ src, imageController }: IImageMediaProps) => {

    return (
        <div className={`album-image`} >
            <div className="album-image__manager-block">
                <button className="album-image__btn remove" onClick={imageController}>
                ...
                <button className="album-image__btn edit">
